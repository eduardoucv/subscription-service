    ...
    describe('on find method fails', () => {
      it('should throw error', async () => {
        ...
        try {
          ...
          expect(e.message).toEqual('Error getting all subscription');
        }
      });
    });
  });
    ...
    describe('on find method fails', () => {
      it('should throw error', async () => {
        ...
        try {
          ...
          expect(e.message).toEqual('Error getting subscription');
        }
      });
    });
  });
    ...
    describe('on find method fails', () => {
      it('should throw error', async () => {
        ...
        try {
          ...
          expect(e.message).toEqual('Error canceling subscription');
        }
      });
    });
  });
    ...
    describe('on find method fails', () => {
      it('should throw error', async () => {
        ...
        try {
          ...
          expect(e.message).toEqual('Error adding a subscription');
        }
      });
    });
  });
